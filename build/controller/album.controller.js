...
const getListAlbums = () => __awaiter(void 0, void 0, void 0, function* () {
    const getAllalbums = yield Album_model_1.AlbumModel.find();
    return getAllalbums;
});
exports.getListAlbums = getListAlbums;
const getAlbumById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const albumById = yield Album_model_1.AlbumModel.findById({ id });
    return albumById;
});
exports.getAlbumById = getAlbumById;
const updateAlbum = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
