...
//CRUD
exports.createSong = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const song = yield Song_model_1.SongModel.create(data);
    return song;
});
exports.getListSongs = () => __awaiter(void 0, void 0, void 0, function* () {
    const getAllSong = yield Song_model_1.SongModel.find()
        .populate('singerID')
        .populate('albumID');
    return getAllSong;
});
exports.getSongById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const getSongById = yield Song_model_1.SongModel.findById(id);
    return getSongById;
});
exports.updateSong = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
    const updatedSong = yield Song_model_1.SongModel.updateOne({ id }, data);
    return updatedSong;
});
exports.deleteSong = (id) => __awaiter(void 0, void 0, void 0, function* () {
