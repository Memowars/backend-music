...
exports.loginUser = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const token = yield generarJWT_1.generarJWT({ _id: _id, email });
...
exports.revalidarToken = (req, res = response) => __awaiter(void 0, void 0, void 0, function* () {
    const { _id, email } = req;
    const token = yield generarJWT_1.generarJWT({ _id, email });
    res.json({
        ok: true,
        token,
        _id,
