...
const getListGenres = () => __awaiter(void 0, void 0, void 0, function* () {
    const getAllGenre = yield Genre_model_1.GenreModel.find();
    return getAllGenre;
});
exports.getListGenres = getListGenres;
...
const updateGenre = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
