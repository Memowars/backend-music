...
const AlbumRoute = (app) => {
    ...
    router.post('/createAlbum', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const album = yield (0, album_controller_1.createAlbum)(req.body);
        res.status(201).json(album);
    }));
    router.get('/getAlbums/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const getAllAlbums = yield (0, album_controller_1.getListAlbums)();
        res.status(200).json(getAllAlbums);
    }));
    router.get('/getAlbumById/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const { id } = req.params;
        const AlbumById = (0, album_controller_1.getAlbumById)(id);
        res.status(200).json(AlbumById);
    }));
    router.patch('/updateAlbum/:id', (req, res) => {
        const { id } = req.params;
        const updatedAlbum = (0, album_controller_1.updateAlbum)(id, req.body);
        res.status(200).json(updatedAlbum);
        router.delete('/deleteAlbum/:id', (req, res) => {
            const { id } = req.params;
            const deletedAlbum = (0, album_controller_1.deleteAlbum)(id);
